...
//             // TODO?: Fix here
//             return BlocProvider(
//                 create: (context) => TripBloc(vehicleRepository: VehicleRepositoryImpl())
...
//               BlocProvider.of<VehicleDetailBloc>(context)
//                   .add(FullyLoadVehicle(vehicle: state.vehicle));
//             }
//
...
//                                   return BlocProvider(
//                                       create: (context) =>
//                                           TripBloc(vehicleRepository: VehicleRepositoryImpl())
